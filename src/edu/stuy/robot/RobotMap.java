...
public interface RobotMap {
    ...
    double LAYUP_SHOOTING_DISTANCE = 4 * 12.0; // front omniwheel (on arm) 4 ft from tower
    double COURTYARD_SHOOTING_DISTANCE = 8 * 12.0; // front omniwheel (on arm) 8 ft from tower
