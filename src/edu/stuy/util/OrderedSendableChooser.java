...
/**
 * The {@link OrderedSendableChooser} class is a useful tool for presenting
 * a selection of options to the {@link SmartDashboard}.
 *
 ...
 * run as an autonomous into a {@link OrderedSendableChooser} and then put it
 * into the {@link OrderedSmartDashboard} to have a list of options appear on
 * the laptop. Once autonomous starts, simply ask the {@link
 * OrderedSendableChooser} what the selected value is.
 *
 * {@link OrderedSendableChooser} is a modification of {@link SendableChooser}
 * which uses a {@link LinkedHashMap} instead of a {@link HashMap} to store
 * choices. It is meant to force the ordering of choices on SmartDashboard to
