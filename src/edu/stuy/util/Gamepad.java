 ...
 * F310).
 * 
 * @author wangmeister, photonix
 */
public class Gamepad extends Joystick {

    /**
     * If {@code invertAnalogY} is {@code true} then moving up will return
     * positive values. By default, it is {@code false}.
     */
    private boolean invertAnalogY;
    ...
    /**
     * The left analog stick y-axis. If {@code setAnalogYInverted} is set to
     * {@code true}, then moving the analog stick upwards will return {@code
     * +1.0} rather than {@code -1.0}.
     * 
    ...
    /**
     * The right analog stick y-axis. If {@code setAnalogYInverted} is set to
     * {@code true}, then moving the analog stick upwards will return {@code
     * +1.0} rather than {@code -1.0}.
     * 
    ...
    /**
     * Sets the invertedness of analog Y axis on the gamepad (both right and
     * left sides). By default, the setting is {@code false} and moving the
     * analog sticks up will return negative values.
     *
     * @param invert - Whether or not to invert the analog Y axis
     */
    public void setAnalogYInverted(boolean invert) {
        invertAnalogY = invert;
    }
}
