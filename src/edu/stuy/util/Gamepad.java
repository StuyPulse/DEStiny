...
public class Gamepad extends Joystick {
    ...
    public void rumbleInTheJungle() {
        setRumble(RumbleType.kLeftRumble, (float) 0.85);
        setRumble(RumbleType.kRightRumble, (float) 0.85);
    }

    public void stopRumble() {
        setRumble(RumbleType.kLeftRumble, 0.0f);
        setRumble(RumbleType.kRightRumble, 0.0f);
    }
